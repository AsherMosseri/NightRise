...
const ICON_PATHS = {
  ...
  gear: 'M12 9.5a2.5 2.5 0 1 0 0 5 2.5 2.5 0 0 0 0-5zM4.5 12l-1.6-1.2 1.4-2.4 1.9.6 1.7-1L8.3 6h2.8l.4 2 1.7 1 1.9-.6 1.4 2.4L14.9 12l1.6 1.2-1.4 2.4-1.9-.6-1.7 1-.4 2H8.3l-.4-2-1.7-1-1.9.6-1.4-2.4z',
  volume: 'M5 10v4h3l4 4V6L8 10H5zM16 9.5a4 4 0 0 1 0 5M18.5 7a7 7 0 0 1 0 10',
  mute: 'M5 10v4h3l4 4V6L8 10H5zM16 10l4 4M20 10l-4 4',
